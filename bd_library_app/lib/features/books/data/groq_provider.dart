...
/// Fournisseur de métadonnées livre/BD via l'API Groq (format compatible OpenAI).
class GroqProvider implements LlmMetadataProvider {
  GroqProvider(this._keyStore);

  final LlmKeyStore _keyStore;

  @override
  bool get isConfigured => _keyStore.isConfigured(LlmProvider.groq);
